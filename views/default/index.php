		...
		<ul>
				...
				<div class="fss">
					...
					<script>
						function observations(){
							...
							$.ajax({
							    url:'/ph/waterwatcher/default/allobservation',
							    type:"GET",
							    success:function(data) {
			...
			<li class="block"><a href="/ph/waterwatcher/default/addObservation">Add an observations</a><br/>
				...
				<div class="apiForm addObservation">
					...
					Télephone : <input type="text" name="addObservationtelephone" id="addObservationtelephone" value="" />* Vous serez contacté par le CROSS<br/>
						...
						function addObservation(){
							...
							$.ajax({
							    ...
							    data:{ "type" : $("#typeaddObservation").val() , 
							    	   ...
							    	   "telephone":$("#addObservationtelephone").val()
							    	},
							    success:function(data) {
